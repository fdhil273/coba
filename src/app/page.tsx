...
export default function MainPage() {
  ...
  return (
    <div className="w-full md:max-w-4xl lg:max-w-5xl bg-[#d9eefa] min-h-screen md:min-h-[85vh] md:my-8 md:rounded-3xl md:shadow-2xl md:border md:border-[#CEA273]/20 relative flex flex-col pb-20 md:pb-8 select-none overflow-hidden mx-auto">
      ...
      <main className="flex-1 overflow-y-auto px-4 md:px-8 py-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
              {filteredSchedules.length === 0 ? (
                ...
                filteredSchedules.map((item, index) => (
                  <div 
                    key={index} 
                    className="bg-white rounded-3xl border border-white shadow-sm overflow-hidden flex flex-col transition-all hover:shadow-md h-full group"
                  >
                    {/* Activity photo at the top (Dengan tinggi yang optimal) */}
                    {item.image_url && (
                    ...
                    <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2 pt-1">
                          <div className="flex items-center gap-2 text-xs text-gray-600 font-medium">
                            <Clock size={14} className="text-[#015185]" />
                            <span>{item.datetime}</span>
                          </div>
                          <div className="flex items-start gap-2 text-xs text-gray-600 font-medium">
                            <MapPin size={14} className="text-[#CEA273] shrink-0 mt-0.5" />
                      ...
                      {item.registration_url && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="bg-[#015185] hover:bg-[#01416b] text-white py-3.5 px-4 text-center font-bold text-xs flex items-center justify-center gap-1.5 transition-colors active:scale-95 duration-100 min-h-[48px] rounded-xl shadow-sm border border-white/10"
                        >
                          Daftar Kajian Sekarang
        ...
        {activeTab === "registrasi" && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="text-center py-2 space-y-1">
              ...
              <p className="text-xs text-[#5990C0] font-medium">
                Pilih program di bawah untuk bergabung melalui tautan formulir resmi.
              </p>
            </div>

            {/* Linktree-like grid on desktop */}
                ...
                registration.map((item, index) => (
                  <div key={index} className="space-y-1 flex flex-col justify-end">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full bg-[#015185] hover:bg-[#01416b] text-white px-5 py-4 rounded-2xl shadow-sm hover:shadow flex items-center justify-between transition-all active:scale-[0.98] duration-100 min-h-[56px] border border-white/15"
                    >
                      <span className="font-extrabold text-sm tracking-tight text-left">
                        {item.button_text}
                      </span>
            ...
            <div className="bg-white/40 border border-white/60 p-4 rounded-2xl mt-4 max-w-xl mx-auto">
              <div className="flex gap-2">
                ...
                <p className="text-[11px] text-gray-700 leading-relaxed font-medium">
                  <strong>Catatan:</strong> Setelah mengisi formulir pendaftaran, pastikan Anda menyimpan kontak admin atau bergabung ke WhatsApp group kajian untuk konfirmasi kehadiran.
                </p>
              </div>
            </div>
        ...
        {activeTab === "faq" && (
          <div className="space-y-6 animate-fadeIn max-w-2xl mx-auto w-full">
            ...
            {/* Accordion Component (Hanya satu yang boleh terbuka, sesuai PRD) */}
            <div className="space-y-3">
              {faq.length === 0 ? (
        ...
        {activeTab === "kontak" && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
              ...
              {/* Left Column: WA Admin & Maps Location */}
                  ...
                  <div className="space-y-2">
                    ...
                    <a
                      href={getWhatsAppLink(
                        settings.contact_wa_number,
                        "Assalamu'alaikum Admin MT. In'am Muslimah x Mahabbah Community, saya ingin bertanya terkait kegiatan kajian..."
                      )}
                      target="_blank"
                      rel="noopener noreferrer"
              ...
              {/* Right Column: Social Media List */}
      ...
      {/* Fixed Bottom Navigation Bar (Hanya tampil di Mobile/Tablet kecil, Sesuai PRD) */}
